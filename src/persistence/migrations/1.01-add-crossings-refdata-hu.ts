...
const HU_BORDER_CROSSING_ENTRIES = [
  ...
  {'id': 24, 'name': 'Tompa - Kelebija', 'foreign_country_code': 'RS', 'open_from':'0000', 'open_until': '2400'},
  ...
  {'id': 37, 'name': 'Hegyeshalom - Nickelsdorf közút (1-es főút)', 'foreign_country_code': 'AT', 'open_from':'0000', 'open_until': '2400'},
  {'id': 38, 'name': 'Jánossomorja - Andau', 'foreign_country_code': 'AT', 'open_from':'0000', 'open_until': '2400'},
  {'id': 39, 'name': 'Kópháza - Deutschkreutz', 'foreign_country_code': 'AT', 'open_from':'0000', 'open_until': '2400'},
  {'id': 40, 'name': 'Kőszeg - Rattersdorf', 'foreign_country_code': 'AT', 'open_from':'0000', 'open_until': '2400'},
  {'id': 41, 'name': 'Pinkamindszent - Strem', 'foreign_country_code': 'AT', 'open_from':'0000', 'open_until': '2400'},
  {'id': 42, 'name': 'Rábafüzes - Heiligenkreutz', 'foreign_country_code': 'AT', 'open_from':'0000', 'open_until': '2400'},
  {'id': 43, 'name': 'Sopron - Klingenbach', 'foreign_country_code': 'AT', 'open_from':'0000', 'open_until': '2400'},
  {'id': 44, 'name': 'Szentpéterfa - Eberau', 'foreign_country_code': 'AT', 'open_from':'0000', 'open_until': '2400'},
  {'id': 45, 'name': 'Zsira - Lutzmannsburg', 'foreign_country_code': 'AT', 'open_from':'0000', 'open_until': '2400'}
];
